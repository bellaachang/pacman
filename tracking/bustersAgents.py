...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        for i in range(len(livingGhostPositionDistributions)):
            mostLikely.append(max(livingGhostPositionDistributions[i], key=livingGhostPositionDistributions[i].get))
        ...
        for l in legal:
            ...
            for g in mostLikely:
                if self.distancer.getDistance(successorPosition, g) < bestDistance:
                    bestAction = l
                    bestDistance = self.distancer.getDistance(successorPosition, g)
